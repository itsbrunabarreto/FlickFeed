...
export default function EpisodeFormShow() {
  ...
  if (loading) return <p className="loading-text">Carregando episódio...</p>;
  if (!episode) return <p className="error-text">{errorMsg}</p>;
    ...
    <div className="episode-show-container">
      <div className="episode-header">
        <div className="episode-info">
          ...
          <p><strong>Data de exibição:</strong> {episode.air_date || 'N/A'}</p>
          <p><strong>Descrição:</strong> {episode.description || 'Sem descrição.'}</p>
        </div>
      </div>
